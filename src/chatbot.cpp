...
ChatBot::ChatBot(std::string filename)
{
    ...
    std::cout << "ChatBot Constructor calls wxBitmap Constructor." << std::endl;
...
ChatBot::~ChatBot()
{
    ...
    {
        std::cout << "ChatBot Destructor calls wxImage Destructor" << std::endl;
        delete _image;
        _image = NULL;
    }
}
